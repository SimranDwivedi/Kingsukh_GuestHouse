		...
		<>
			<div id='about'>
				...
				<div className='text'>
					...
					<span className='next2'>
						<p>
							Embark on a tranquil journey at our Kingsukh Guest
							House, enveloped by the scenic allure of Biharinath
							Hill, Baranti Hill, Susunia Hill, Joychandi Hill,
							Garhpanchkot, Baranti Dam, Maithon Dam, and the
							captivating Panchat Dam. Revel in the embrace of
							comfort, relish delightful meals, and unwind in our
							verdant garden oasis. Your ideal retreat beckons,
							promising a harmonious blend of nature's beauty and
							heartfelt hospitality. Explore the hidden gems of
							Purulia, creating memories that linger long after
							your stay.
						</p>
						<a href="https://maps.app.goo.gl/7wYUEB4tvR7NMHbcA">
							Address: Beside Barshal Water Tank, Manpur,
          ...
          <a href="https://wa.link/at5ion">
			...
			<div className='rooms' id='rooms'>
				...
				<div class='card-group'>
					<div class='card'>
						...
						<div class='card-body'>
							<h2 class='card-title'>Cozy Haven Room </h2>
							<br />
							<p class='card-text'>
								Escape to comfort in our Cozy Haven Room, a snug
								retreat designed for intimate relaxation. <br />
								<br />
              ...
              <a href="https://wa.link/at5ion">
					...
					<div class='card'>
						...
						<div class='card-body'>
							<h2 class='card-title'>Spacious Serenity Suite</h2>
							<br />
							<p class='card-text'>
								Indulge in luxury and ample space in our
								Spacious Serenity Suite, where tranquility meets
								roomy elegance.
								<br />
								<br />
			...
			<div className='services' id='services'>
				...
				<div className='sevices-img service-img-2'>
					<img src='palash.webp'></img>
				</div>
			</div>
			<div>
			...
			<section id='contact' class='section1'>
				<div class='container1'>
					...
					<div class='contactForm1' id="account">
